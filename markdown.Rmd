...
# Coeficientes del estimador lineal local
# USAMOS LA HOPTIMA CALCULADA ANTERIORMENTE 

coeficientes <- linearsmooth(mujeres$HIP.CIRCUMFERENCE, mujeres$BUTTOCK.KNEE.LENGTH, 41, mujeres$HIP.CIRCUMFERENCE)
ordenada <- coeficientes[1]
pendiente <- coeficientes[2]

# Graficar el diagrama de dispersión

ordenada <- 321.1275109
pendiente <- 0.8337998
...
plot(mujeres$HIP.CIRCUMFERENCE, mujeres$BUTTOCK.KNEE.LENGTH,
     ...
     ylab = "Longitud del fémur (mm)", 
     col = "purple")
abline(321, 2, col = "blue", lwd = 2)
legend("topleft", legend = "Recta ajustada", col = "blue", lwd = 2)
